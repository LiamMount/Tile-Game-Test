...
public class ColinMenu : MonoBehaviour
{
    GameMaster gm;
    ...
    public void MenuUsage()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Z))
        {
            ...
            else if (arrow.transform.position == attackTransform.position)
            {
                ...
                {
                    gm.selectedUnit.attackType = "Hammer"; // Change later when we have multiple attack types
                    gm.selectedUnit.aoeType = true;
